...
Will fetch ID of user from TikTok API. May throw an error in certain situations, see [here](./api/api.ts#L10).
...
See [UserInfo](#UserInfo) for a defintion of the UserInfo object. May throw an error in certain situations, see [here](./api/api.ts#L30).
...
See [VideoInfo](#VideoInfo) for a definition of the VideoInfo object. May throw an error in certain situations, see [here](./api/api.ts#L51).
...
May throw an error in certain situations, see [here](./api/api.ts#L69).
...
May throw an error in certain situations, see [here](./api/api.ts#L95).
...
See [AudioInfo](#AudioInfo) for a definition of the AudioInfo object. May throw an error in certain situations, see [here](./api/api.ts#L124).
...
The first object of this VideoInfo array will be the original video with the audio. May throw an error in certain situations, see [here](./api/api.ts#L145).
...
Will fetch the title from the TikTok API, therefore this function returns a promise. May throw an error in certain situations, see [here](./api/api.ts#L158).
...
See [TagInfo](#TagInfo) for a definition of the TagInfo object. May throw an error in certain situations, see [here](./api/api.ts#L169).
...
May throw an error in certain situations, see [here](./api/api.ts#L187).
